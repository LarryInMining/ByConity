...
./packager --output-dir deb/test_output/ --package-type deb --docker-image-version stable --ccache_dir=/data01/minh.dao/.ccache_for_docker --version 0.1.1.1
...
``` sh
$ mkdir deb/test_output/
$ ./packager --output-dir deb/test_output/ --package-type deb --docker-image-version stable --ccache_dir=/your/cache/path/.ccache_for_docker --additional-pkgs --version 0.1.1.1
$ ls -l deb/test_output/
